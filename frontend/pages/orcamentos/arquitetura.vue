  ...
  <div class="budget-page">
    <v-container class="budget-container df-width">
      <v-form
        ref="form"
        v-model="valid"
        class="orcamento-form mt-10"
        @submit.prevent="submitBudget"
      >
        <v-stepper v-model="e6" vertical class="elevation-11">
          <v-stepper-header>
            <v-stepper-step editable :complete="e6 > 1" step="1" class="h4">Orçamento</v-stepper-step>
              ...
              <v-container>
                <v-row class="mt-2">
                  ...
                  <v-col cols="12" lg="1" xs="12" class="pt-6">
                    <v-checkbox class="py-0 my-0" v-model="enabled3" hide-details outlined></v-checkbox>
                  </v-col>
                  ...
                  <v-col cols="12" lg="1" xs="12" class="pt-6">
                    <v-checkbox class="py-0 my-0" v-model="enabled4" hide-details outlined></v-checkbox>
                  </v-col>
                  <v-col cols="12" lg="5" xs="12">
                    <v-select
                      label="Arquitetura"
                  ...
                  <v-col cols="12" xs="12" sm="8" md="9" lg="10" class="my-0 py-0">
                    <TermsPrivacy />
                  </v-col>
                  <v-col cols="12" xs="12" sm="4" md="3" lg="2" class="my-0 pl-custom py-0">
                    <v-btn
                      type="submit"
                      right
            ...
            <div class="mb-12">
              <v-container>
                <v-row>
                  <v-col cols="12" lg="12">
                    <div class="h3-custom center d-flex align-center">
                      <v-icon
                        ...
                        class="pr-2"
                      >mdi-checkbox-marked-circle</v-icon>Parabens o seu orcamento foi criado com sucesso!
                    </div>
                  ...
                  <v-col cols="12" md="12" lg="10" class="my-0 py-0"></v-col>
...
<script>
import TermsPrivacy from "@/components/Helpers/TermsPrivacy";
...
export default {
  ...
  data() {
    return {
      ...
      specialtyAreaItems: ["Arquitetura e Urbanismo"],
      ...
      inputRules: [
        (value) =>
          !value ||
          value.size < 3000000 ||
          "As imagens devem contar menos de 3 MB!",
      ],
      nameRules: [
        (v) => !!v || "O nome é obrigatório",
        (v) =>
          v.length <= 20 ||
          "O campo Nome não pode conter mais de 20 caracteres",
      ],
