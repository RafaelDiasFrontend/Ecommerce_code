...
<v-app id="inspire">
    <v-navigation-drawer v-model="drawer" :clipped="$vuetify.breakpoint.lgAndUp" app class='bg-primary-color' :class="{ darkColor: themeDark }" dark>
        ...
        <div class='theme-color-change-adm'>
            <v-list-item>
                <v-list-item-action>
            ...
            <v-list-item>
                <v-list-item-action>
                    <v-switch disabled color='secondary' v-model='themePremium' @change="themePremium =!themePremium"></v-switch>
                </v-list-item-action>
                <v-list-item-content>
                    <v-list-item-title>
                        Premium
      ...
      /> -->
        ...
        <template v-if="authenticated">
            <ul class='d-flex align-center font-weight-bold'>
                ...
                <li class='pr-5 pl-1'>
                    <v-badge :content="messages" :value="messages" color='secondary' overlap>
